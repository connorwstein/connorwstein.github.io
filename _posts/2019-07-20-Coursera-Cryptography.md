...
### Message Integrity
MACs are typically based on PRFs rather than PRPs because they need not be invertible. There is a few different types of MACs:
- CBC-MAC
- NMAC
- PMAC
- Carter-Wegman MAC
